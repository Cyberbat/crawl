...
<html lang="en">
<head>
    <title>Code coverage report for src/components/VuetablePaginationDropdown.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/components/</a> VuetablePaginationDropdown.vue
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.$on('vuetable:pagination-data', (tablePagination) =&gt; <span class="fstat-no" title="function not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >        self.setPaginationData(tablePagination)</span>
      })
    }
  },
  created () {
<span class="cstat-no" title="statement not covered" >    this.registerEvents()</span>
  }
}
&lt;/script&gt;
&nbsp;</pre></td></tr>
